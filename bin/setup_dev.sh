...
oc new-build --binary=true --name="tasks" --image-stream=openshift/jboss-eap71-openshift:1.3 -n ${GUID}-tasks-dev
...
oc set probe dc/tasks --liveness --get-url=http://:8080/ --initial-delay-seconds=180 --timeout-seconds=1 -n ${GUID}-tasks-dev
